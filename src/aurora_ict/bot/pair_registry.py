...
# 2026-07-08 Origo 1.6 풀구성(conf5·SLx4·rr2.0·트레일+BE) 5년+전/후반 재검증으로 갱신
# (파트너 결정: 추천 배지만, 고정 리스트 불변):
#   FIL(+85, 전/후반 +9/+76) · ARB(+79, +38/+40, DD 23) — 둘 다 walk-forward 통과.
#   ENA(-95)·NEAR(-33) 는 새 구성에서 적자 반전 → 제거. 교훈: 게이트 구성이
#   바뀌면 페어 적합성도 재검증 (6/18 순위가 1.6 에선 무효).
RECOMMENDED_PAIRS = (
    "FIL/USDT:USDT",
    "ARB/USDT:USDT",
)
