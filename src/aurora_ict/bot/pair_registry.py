...
# 2026-06-18 Origo 1.1 게이트(cisd+po3·conf4·ttl6·sl x3) 5년 net 재검증으로 갱신:
#   ARB(+14.8/승률44%) > FIL(+7.6/30%) > ENA(+6.8/32%) > NEAR(+0.9/28%).
#   기존 2026-06-12 9국면 순위(NEAR>ENA>FIL>ARB)에서 ARB 가 Origo 1 기준 압도적
#   1위로 — 운영 게이트와 정합한 순위가 사용자에게 더 나은 페어를 먼저 보여줌.
RECOMMENDED_PAIRS = (
    "ARB/USDT:USDT",
    "FIL/USDT:USDT",
    "ENA/USDT:USDT",
