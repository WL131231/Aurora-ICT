...
class BotManager:
    ...
    async def _do_start(self) -> BotStatus:
        ...
        self._bot = BotIctInstance(
            ...
            risk_based_sizing=self.settings.risk_based_sizing,
            risk_per_trade_base=self.settings.risk_per_trade_base,
            risk_per_trade_step=self.settings.risk_per_trade_step,
            risk_per_trade_max=self.settings.risk_per_trade_max,
