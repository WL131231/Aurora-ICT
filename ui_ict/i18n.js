...
(function () {
  ...
  const DICT = {
    ko: {
      ...
      "sidebar.dailyLimits": "DAILY LIMITS",
      ...
      "label.slLimitPct": "SL Limit %",
      "label.tpLimitPct": "TP Limit %",
      "label.off": "0 = off",
      "label.language": "언어",
      "label.timezone": "시간대",
      // hint
      "hint.pairSelect": "🔒 고정 7페어는 START 시 자동 가동 — 추가로 3개까지 직접 선택 가능",
      "hint.tradeTf": "진입 봉 단위 — 선택한 TF 이상 봉으로 매매 결정 (1m 은 노이즈로 제외)",
      // killzone
      "kz.asian": "Asian",
      "kz.london": "London",
      "kz.london_close": "LDN Close",
      "kz.ny_am": "NY AM",
      "kz.pm": "NY PM",
      "kz.weekend": "주말 휴장",
      "kz.weekend_sub": "매매 없음",
      // 라이선스 카드
    ...
    en: {
      ...
      "hint.pairSelect": "🔒 7 core pairs auto-start with START — pick up to 3 more yourself",
      ...
      "trades.csvAll": "Download All Users CSV",
    ...
    zh: {
      ...
      "label.limitPct": "上限 %",
      "label.slLimitPct": "SL上限 %",
      "label.tpLimitPct": "TP上限 %",
      "label.off": "0 = 关闭",
      "label.language": "语言",
      "label.timezone": "时区",
      "hint.pairSelect": "🔒 7个固定交易对随START自动启动 — 可再自选最多3个",
      "hint.tradeTf": "入场K线周期 — 选定TF以上的K线决策 (1m作为噪音排除)",
      "kz.asian": "亚洲",
      "kz.london": "伦敦",
      "kz.london_close": "伦敦收盘",
      "kz.ny_am": "纽约早市",
      "kz.pm": "纽约午市",
      "kz.weekend": "周末",
      "kz.weekend_sub": "休市",
    ...
    ja: {
      ...
      "hint.pairSelect": "🔒 固定7ペアはSTARTで自動稼働 — さらに最大3ペアまで選択可能",
      "hint.tradeTf": "エントリー足単位 — 選択TF以上の足で判定 (1mはノイズ除外)",
      "kz.asian": "アジア",
      "kz.london": "ロンドン",
      "kz.london_close": "LDNクローズ",
      "kz.ny_am": "NY 前場",
      "kz.pm": "NY 後場",
      "license.title": "ライセンス",
      "license.type": "タイプ",
